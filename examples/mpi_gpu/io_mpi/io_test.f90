...
program io_test
   ...
   call decomp_2d_write_one(1, u1, 'u1.dat', opt_dirname='out')
   call decomp_2d_write_one(2, u2, 'u2.dat', opt_dirname='out')
   call decomp_2d_write_one(3, u3, 'u3.dat', opt_dirname='out')
   ...
   call io%open("checkpoint", decomp_2d_write_mode)
   ...
   ! read back to different arrays
   u1b = 0; u2b = 0; u3b = 0
   call io%open("checkpoint", decomp_2d_read_mode)
   call decomp_2d_read_var(io, 1, u1b)
   call decomp_2d_read_var(io, 2, u2b)
   call decomp_2d_read_var(io, 3, u3b)
   call io%close
